...
Partial Class frmAcceso
    ...
    Private Sub InitializeComponent()
        ...
        Guna2Panel1.FillColor = Color.FromArgb(CByte(28), CByte(31), CByte(38))
        Guna2Panel1.Font = New Font("Segoe UI", 9.75F)
        Guna2Panel1.Location = New Point(0, 461)
        ...
        btnGen.BackColor = Color.FromArgb(CByte(28), CByte(31), CByte(38))
        ...
        AutoSize = True
        BackColor = Color.FromArgb(CByte(253), CByte(253), CByte(253))
