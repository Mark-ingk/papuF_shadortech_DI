...
Partial Class frmCambiarContraseña
    ...
    Private Sub InitializeComponent()
        ...
        ' 
        pnlCambiarContraseña.Controls.Add(btnCancelarCambiosCambiarContraseña)
        pnlCambiarContraseña.Controls.Add(btnGuardarCambiosCambiarContraseña)
        pnlCambiarContraseña.Controls.Add(lblConfirmarContraseña)
        pnlCambiarContraseña.Controls.Add(txtConfirmarContraseña)
        pnlCambiarContraseña.Controls.Add(lblNuevaContraseña)
        pnlCambiarContraseña.Controls.Add(txtNuevaContraseña)
        pnlCambiarContraseña.Controls.Add(lblContraseñaActual)
        pnlCambiarContraseña.Controls.Add(txtContraseñaActual)
        pnlCambiarContraseña.Controls.Add(btnRegresarCambiarContraseña)
        pnlCambiarContraseña.Controls.Add(lblCambiarContraseña)
        ...
        lblNuevaContraseña.Font = New Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblNuevaContraseña.ForeColor = SystemColors.ButtonHighlight
        lblNuevaContraseña.Location = New Point(13, 170)
        lblNuevaContraseña.Margin = New Padding(4, 0, 4, 0)
        lblNuevaContraseña.Name = "lblNuevaContraseña"
        lblNuevaContraseña.Size = New Size(364, 28)
        lblNuevaContraseña.TabIndex = 33
        ...
        txtNuevaContraseña.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtNuevaContraseña.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtNuevaContraseña.FillColor = Color.FromArgb(CByte(42), CByte(42), CByte(42))
        txtNuevaContraseña.FocusedState.BorderColor = Color.FromArgb(CByte(231), CByte(254), CByte(37))
        txtNuevaContraseña.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtNuevaContraseña.ForeColor = Color.FromArgb(CByte(170), CByte(170), CByte(170))
        txtNuevaContraseña.HoverState.BorderColor = Color.FromArgb(CByte(231), CByte(254), CByte(37))
        txtNuevaContraseña.Location = New Point(13, 201)
        txtNuevaContraseña.Margin = New Padding(4, 67, 4, 25)
        txtNuevaContraseña.Name = "txtNuevaContraseña"
        txtNuevaContraseña.PasswordChar = "*"c
        ...
        ' lblContraseñaActual
        ' 
        lblContraseñaActual.BackColor = Color.Transparent
        lblContraseñaActual.Font = New Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblContraseñaActual.ForeColor = SystemColors.ButtonHighlight
        lblContraseñaActual.Location = New Point(13, 90)
        lblContraseñaActual.Margin = New Padding(4, 0, 4, 0)
        lblContraseñaActual.Name = "lblContraseñaActual"
        lblContraseñaActual.Size = New Size(364, 28)
        lblContraseñaActual.TabIndex = 31
        ...
        txtContraseñaActual.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtContraseñaActual.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtContraseñaActual.FillColor = Color.FromArgb(CByte(42), CByte(42), CByte(42))
        txtContraseñaActual.FocusedState.BorderColor = Color.FromArgb(CByte(231), CByte(254), CByte(37))
        txtContraseñaActual.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtContraseñaActual.ForeColor = Color.FromArgb(CByte(170), CByte(170), CByte(170))
        txtContraseñaActual.HoverState.BorderColor = Color.FromArgb(CByte(231), CByte(254), CByte(37))
        txtContraseñaActual.Location = New Point(13, 121)
        txtContraseñaActual.Margin = New Padding(4, 67, 4, 25)
        txtContraseñaActual.Name = "txtContraseñaActual"
        txtContraseñaActual.PasswordChar = "*"c
        ...
        btnRegresarCambiarContraseña.ForeColor = Color.FromArgb(CByte(15), CByte(15), CByte(15))
        btnRegresarCambiarContraseña.ImageAlign = ContentAlignment.BottomCenter
        btnRegresarCambiarContraseña.Location = New Point(0, 0)
    ...
    Friend WithEvents txtContraseñaActual As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents lblContraseñaActual As Label
    Friend WithEvents lblNuevaContraseña As Label
    Friend WithEvents txtNuevaContraseña As Guna.UI2.WinForms.Guna2TextBox
    ...
    Friend WithEvents btnGuardarCambiosCambiarContraseña As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnCancelarCambiosCambiarContraseña As Guna.UI2.WinForms.Guna2Button
End Class
