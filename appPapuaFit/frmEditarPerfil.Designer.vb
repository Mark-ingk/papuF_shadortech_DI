...
Partial Class frmEditarPerfil
    ...
    Private Sub InitializeComponent()
        ...
        txtCorreoElectronicoEditarPerfil = New Guna.UI2.WinForms.Guna2TextBox()
        lblCorreoElectronicoEditarPerfil = New Label()
        lblGeneroEditarPerfil = New Label()
        cbxGeneroEditarPerfil = New Guna.UI2.WinForms.Guna2ComboBox()
        ...
        ' Panel1
        ' 
        Panel1.Controls.Add(btnCancelarCambiosEditarPerfil)
        Panel1.Controls.Add(btnGuardarCambiosEditarPerfil)
        Panel1.Controls.Add(txtObjetivosPrincipalesEditarPerfil)
        Panel1.Controls.Add(lblObjetivosPrincipalesEditarPerfil)
        Panel1.Controls.Add(txtCorreoElectronicoEditarPerfil)
        Panel1.Controls.Add(lblCorreoElectronicoEditarPerfil)
        Panel1.Controls.Add(lblGeneroEditarPerfil)
        Panel1.Controls.Add(cbxGeneroEditarPerfil)
        ...
        btnGuardarCambiosEditarPerfil.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnGuardarCambiosEditarPerfil.FillColor = Color.FromArgb(CByte(198), CByte(241), CByte(53))
        btnGuardarCambiosEditarPerfil.Font = New Font("Segoe UI", 13.2000008F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        btnGuardarCambiosEditarPerfil.ForeColor = Color.FromArgb(CByte(26), CByte(26), CByte(26))
        ...
        ' 
        ' txtObjetivosPrincipalesEditarPerfil
        ' 
        ...
        txtObjetivosPrincipalesEditarPerfil.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtObjetivosPrincipalesEditarPerfil.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtObjetivosPrincipalesEditarPerfil.FillColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        txtObjetivosPrincipalesEditarPerfil.FocusedState.BorderColor = Color.FromArgb(CByte(231), CByte(254), CByte(37))
        txtObjetivosPrincipalesEditarPerfil.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtObjetivosPrincipalesEditarPerfil.ForeColor = Color.FromArgb(CByte(15), CByte(15), CByte(15))
        txtObjetivosPrincipalesEditarPerfil.HoverState.BorderColor = Color.FromArgb(CByte(231), CByte(254), CByte(37))
        txtObjetivosPrincipalesEditarPerfil.Location = New Point(13, 620)
        txtObjetivosPrincipalesEditarPerfil.Margin = New Padding(4, 67, 4, 25)
        txtObjetivosPrincipalesEditarPerfil.Name = "txtObjetivosPrincipalesEditarPerfil"
        ...
        ' 
        ' lblObjetivosPrincipalesEditarPerfil
        ' 
        lblObjetivosPrincipalesEditarPerfil.Font = New Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblObjetivosPrincipalesEditarPerfil.ForeColor = SystemColors.ButtonHighlight
        lblObjetivosPrincipalesEditarPerfil.Location = New Point(13, 589)
        lblObjetivosPrincipalesEditarPerfil.Margin = New Padding(4, 0, 4, 0)
        lblObjetivosPrincipalesEditarPerfil.Name = "lblObjetivosPrincipalesEditarPerfil"
        lblObjetivosPrincipalesEditarPerfil.Size = New Size(364, 36)
        lblObjetivosPrincipalesEditarPerfil.TabIndex = 45
        lblObjetivosPrincipalesEditarPerfil.Text = "Objetivos Principales"
        ' 
        ' txtCorreoElectronicoEditarPerfil
        ' 
        ...
        txtCorreoElectronicoEditarPerfil.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtCorreoElectronicoEditarPerfil.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        txtCorreoElectronicoEditarPerfil.FillColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        txtCorreoElectronicoEditarPerfil.FocusedState.BorderColor = Color.FromArgb(CByte(231), CByte(254), CByte(37))
        txtCorreoElectronicoEditarPerfil.Font = New Font("Segoe UI", 9F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        txtCorreoElectronicoEditarPerfil.ForeColor = Color.FromArgb(CByte(15), CByte(15), CByte(15))
        txtCorreoElectronicoEditarPerfil.HoverState.BorderColor = Color.FromArgb(CByte(231), CByte(254), CByte(37))
        txtCorreoElectronicoEditarPerfil.Location = New Point(13, 540)
        txtCorreoElectronicoEditarPerfil.Margin = New Padding(4, 67, 4, 25)
        txtCorreoElectronicoEditarPerfil.Name = "txtCorreoElectronicoEditarPerfil"
        ...
        ' 
        ' lblCorreoElectronicoEditarPerfil
        ' 
        lblCorreoElectronicoEditarPerfil.Font = New Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblCorreoElectronicoEditarPerfil.ForeColor = SystemColors.ButtonHighlight
        lblCorreoElectronicoEditarPerfil.Location = New Point(13, 509)
        lblCorreoElectronicoEditarPerfil.Margin = New Padding(4, 0, 4, 0)
        lblCorreoElectronicoEditarPerfil.Name = "lblCorreoElectronicoEditarPerfil"
        lblCorreoElectronicoEditarPerfil.Size = New Size(364, 36)
        lblCorreoElectronicoEditarPerfil.TabIndex = 43
        lblCorreoElectronicoEditarPerfil.Text = "Correo Electronico"
        ' 
        ' lblGeneroEditarPerfil
        ' 
        lblGeneroEditarPerfil.BackColor = Color.Transparent
        lblGeneroEditarPerfil.Font = New Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblGeneroEditarPerfil.ForeColor = SystemColors.ButtonHighlight
        lblGeneroEditarPerfil.Location = New Point(13, 429)
        lblGeneroEditarPerfil.Margin = New Padding(4, 0, 4, 0)
        lblGeneroEditarPerfil.Name = "lblGeneroEditarPerfil"
        lblGeneroEditarPerfil.Size = New Size(364, 28)
        lblGeneroEditarPerfil.TabIndex = 42
        lblGeneroEditarPerfil.Text = "Genero"
        ' 
        ' cbxGeneroEditarPerfil
        ' 
        ...
        cbxGeneroEditarPerfil.FocusedColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        cbxGeneroEditarPerfil.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        cbxGeneroEditarPerfil.Font = New Font("Segoe UI", 10F)
        cbxGeneroEditarPerfil.ForeColor = Color.FromArgb(CByte(15), CByte(15), CByte(15))
        cbxGeneroEditarPerfil.ItemHeight = 30
        ...
        txtNombreEditarPerfil.ForeColor = Color.FromArgb(CByte(15), CByte(15), CByte(15))
    ...
    Friend WithEvents cbxGeneroEditarPerfil As Guna.UI2.WinForms.Guna2ComboBox
    Friend WithEvents lblGeneroEditarPerfil As Label
    Friend WithEvents lblCorreoElectronicoEditarPerfil As Label
    Friend WithEvents txtCorreoElectronicoEditarPerfil As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents lblObjetivosPrincipalesEditarPerfil As Label
    Friend WithEvents txtObjetivosPrincipalesEditarPerfil As Guna.UI2.WinForms.Guna2TextBox
    Friend WithEvents btnGuardarCambiosEditarPerfil As Guna.UI2.WinForms.Guna2Button
    Friend WithEvents btnCancelarCambiosEditarPerfil As Guna.UI2.WinForms.Guna2Button
End Class
