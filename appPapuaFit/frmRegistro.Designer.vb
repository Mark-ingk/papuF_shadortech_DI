...
Partial Class frmRegistro
    ...
    Private Sub InitializeComponent()
        ...
        lblReg = New Guna.UI2.WinForms.Guna2HtmlLabel()
        ...
        ' lblReg
        ' 
        lblReg.Anchor = AnchorStyles.Top
        lblReg.BackColor = Color.Transparent
        lblReg.Font = New Font("Segoe UI", 25.8000011F, FontStyle.Bold, GraphicsUnit.Point, CByte(0))
        lblReg.ForeColor = Color.White
        lblReg.Location = New Point(92, 221)
        lblReg.Margin = New Padding(3, 15, 3, 3)
        lblReg.Name = "lblReg"
        lblReg.Size = New Size(181, 48)
        lblReg.TabIndex = 2
        lblReg.Text = "Registrarse"
        ' 
        ' lblO
        ' 
        lblO.BackColor = Color.Transparent
        lblO.Font = New Font("Segoe UI", 20.25F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        lblO.ForeColor = Color.FromArgb(CByte(136), CByte(136), CByte(136))
        lblO.Location = New Point(183, 609)
        lblO.Name = "lblO"
        ...
        Guna2HtmlLabel1.Text = "No tienes cuenta?"
        ' 
        ' pnlRegistro
        ' 
        ...
        pnlRegistro.Location = New Point(0, -2)
        pnlRegistro.Margin = New Padding(0)
        pnlRegistro.MaximumSize = New Size(390, 844)
        pnlRegistro.MinimumSize = New Size(390, 844)
        pnlRegistro.Name = "pnlRegistro"
        pnlRegistro.Padding = New Padding(25, 20, 25, 20)
        ...
        ' lblLog
        ' 
        lblLog.Anchor = AnchorStyles.Top
        ...
        lblLog.Location = New Point(113, 156)
        lblLog.Margin = New Padding(3, 15, 3, 3)
        lblLog.Name = "lblLog"
        lblLog.Size = New Size(165, 48)
        lblLog.TabIndex = 17
        lblLog.Text = "Registrate"
        ' 
        ' spr1
        ' 
        spr1.Location = New Point(12, 644)
        spr1.Name = "spr1"
        ...
        ' spr2
        ' 
        spr2.Location = New Point(224, 644)
        spr2.Name = "spr2"
        ...
        btnINS.Location = New Point(40, 547)
        btnINS.Name = "btnINS"
        ...
        iconPesa.Location = New Point(141, 24)
        iconPesa.Margin = New Padding(3, 40, 3, 3)
        ...
        PerformLayout()
    End Sub
    Friend WithEvents lblReg As Guna.UI2.WinForms.Guna2HtmlLabel
